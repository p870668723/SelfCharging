...
void calibrate_IMU()//陀螺仪校准 
{
        ...
        if(mpu6050.Acc_CALIBRATE)
    {
        ...
        if(mpu6050.Mag_CALIBRATE)
    {
        Go_Mode=STOP;
       // HMC5883L_Start_Calib();
        mpu6050.Mag_CALIBRATE=0;
    }
        if(mpu6050.Baro_CALIBRATE == 1)
    {
        Go_Mode=SCAN;
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;
		ANO_DT_Send_Senser(ureal_irda_data1,ureal_irda_data2,sreal_irda_Position,
		MPU6050_Real_Data.Gyro_X,MPU6050_Real_Data.Gyro_Y,MPU6050_Real_Data.Gyro_Z,
		S_Moto_L.Encoder_V,S_Moto_R.Encoder_V,S_Moto_L.Encoder_L,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid1 = 0;
		ANO_DT_Send_PID(1,PID_LDC1000.Kp,PID_LDC1000.Ti,PID_LDC1000.Td,
                          PID_Gyro_Yaw_Struct.Kp,PID_Gyro_Yaw_Struct.Ti,PID_Gyro_Yaw_Struct.Td,
				  0,0,0
				  );
...
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid2)
	{
		...
		ANO_DT_Send_PID(2,PID_Position_Struct.Kp,PID_Position_Struct.Ti,PID_Position_Struct.Td,
				          ...
				          Set_Moto_Speed/1000,Expect_ProximityData/1000,PID_Yaw_P_Struct.Td);
	}
/////////////////////////////////////////////////////////////////////////////////////
//	else if(f.send_pid3)
//	{
//		f.send_pid3 = 0;
//		ANO_DT_Send_PID(3,PID_LDC1000.Kp,PID_LDC1000.Ti,0,
//		0,0,0,
//		0,0,0);
//	}
...
void ANO_DT_Data_Receive_Anl(u8 *data_buf,u8 num)
{
	...
	_temp1=*(data_buf+4);
	_temp2=*(data_buf+5);
        PID_LDC1000.Kp  = 0.001*( (_temp1<<8)|_temp2 );
		_temp1=*(data_buf+6);
	_temp2=*(data_buf+7);
        PID_LDC1000.Ti  = 0.001*( (_temp1<<8)|_temp2 );
		_temp1=*(data_buf+8);
	_temp2=*(data_buf+9);
         PID_LDC1000.Td  = 0.001*( (_temp1<<8)|_temp2 );
		_temp1=*(data_buf+10);      
  	_temp2=*(data_buf+11);
        PID_Gyro_Yaw_Struct.Kp 	= 0.001*( (_temp1<<8)|_temp2 );
           
		_temp1=*(data_buf+12);
	_temp2=*(data_buf+13);
        PID_Gyro_Yaw_Struct.Ti 	= 0.001*( (_temp1<<8)|_temp2 );
		_temp1=*(data_buf+14);
	_temp2=*(data_buf+15);
        PID_Gyro_Yaw_Struct.Td 	= 0.001*( (_temp1<<8)|_temp2 );
        PID_LDC1000.SumErr=0;
        PID_Gyro_Yaw_Struct.SumErr=0;
	...
	_temp1=*(data_buf+16);
	_temp2=*(data_buf+17);
        Set_Moto_Speed	= ( (_temp1<<8)|_temp2 );
	_temp1=*(data_buf+18);
	_temp2=*(data_buf+19);
       Expect_ProximityData 	= ( (_temp1<<8)|_temp2 );
	_temp1=*(data_buf+20);
	_temp2=*(data_buf+21);

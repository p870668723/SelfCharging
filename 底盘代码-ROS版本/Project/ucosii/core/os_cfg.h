...
#define OS_DEBUG_EN               0u//1u   /* Enable(1) debug variables                                    */

#define OS_EVENT_MULTI_EN         0u//1u   /* Include code for OSEventPendMulti()                          */
...
#define OS_TASK_STAT_STK_CHK_EN   0u//1u   /*     Check task stacks from statistic task                    */
...
#define OS_MUTEX_QUERY_EN         1u   /*     Include code for OSMutexQuery()                          */
                                       ...
                                       /* ---------------------- MESSAGE QUEUES ---------------------- */
#define OS_Q_EN                   0u//1u   /* Enable (1) or Disable (0) code generation for QUEUES         */
